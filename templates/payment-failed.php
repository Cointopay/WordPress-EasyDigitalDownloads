<div id="edd-payment-processing">
	<p><?php printf( __( 'Your purchase is failed. This page will reload automatically in 8 seconds. If it does not, click <a href="%s">here</a>.', 'easy-digital-downloads' ), edd_get_success_page_uri() ); ?>
